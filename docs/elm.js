...
var author$project$Main$PureMsg = function (a) {
	return {$: 'PureMsg', a: a};
};
...
var author$project$WithElmParser$TextareaMsg = function (a) {
...
var author$project$WithElmParser$init = function (idPrefix) {
	...
	return _Utils_Tuple2(
		{textareaModel: m},
		A2(elm$core$Platform$Cmd$map, author$project$WithElmParser$TextareaMsg, c));
};
...
var author$project$Main$init = function () {
	var _n0 = author$project$WithElmParser$init('ta-pure');
	var pureModel = _n0.a;
	var pureCmd = _n0.b;
	...
	return _Utils_Tuple2(
		...
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(elm$core$Platform$Cmd$map, author$project$Main$PureMsg, pureCmd),
					A2(elm$core$Platform$Cmd$map, author$project$Main$PortsMsg, portsCmd)
				])));
}();
...
var author$project$WithElmParser$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(
				elm$core$Platform$Sub$map,
				author$project$WithElmParser$TextareaMsg,
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				author$project$WithElmParser$subscriptions(model.pureModel)),
				A2(
				elm$core$Platform$Sub$map,
...
var author$project$WithElmParser$highlight = function (text) {
	...
	var keywords = A2(
		stylifyMany,
		author$project$WithElmParser$Keyword,
		_List_fromArray(
			['if', 'then', 'else', 'let', 'in', 'module']));
	var identifiers = A2(
		stylifyMany,
		author$project$WithElmParser$Identifier,
		_List_fromArray(
			['foo', 'bar']));
	return _Utils_ap(keywords, identifiers);
};
var author$project$WithElmParser$update = F2(
	function (msg, model) {
		if (msg.$ === 'TextareaMsg') {
			var sub = msg.a;
			...
			var tm2 = function () {
				if ((o.$ === 'Just') && (o.a.$ === 'RequestHighlight')) {
					...
					return A3(
						author$project$Textarea$applyStyles,
						hr.id,
						author$project$WithElmParser$highlight(hr.text),
						tm);
				} else {
					return tm;
				}
...
var author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'PureMsg') {
			var sub = msg.a;
			var _n1 = A2(author$project$WithElmParser$update, sub, model.pureModel);
			var m = _n1.a;
			var c = _n1.b;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{pureModel: m}),
				A2(elm$core$Platform$Cmd$map, author$project$Main$PureMsg, c));
		} else {
			var sub = msg.a;
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{portsModel: m}),
				A2(elm$core$Platform$Cmd$map, author$project$Main$PortsMsg, c));
		}
	});
