...
var author$project$Main2$PortsMsg = function (a) {
	return {$: 'PortsMsg', a: a};
};
var author$project$Main2$PureMsg = function (a) {
	return {$: 'PureMsg', a: a};
};
var author$project$Textarea$defaultInitData = F2(
	function (idPrefix, initialText) {
		return {debounceMs: 200, idPrefix: idPrefix, initialText: initialText};
	});
var author$project$Textarea2$defaultInitData = author$project$Textarea$defaultInitData;
...
var author$project$Internal$Styles$empty = author$project$Internal$Styles$Styles(_List_Nil);
...
var author$project$Internal$Styles$addStyles = F2(
	function (ss, _n0) {
		var styles = _n0.a;
		return author$project$Internal$Styles$Styles(
			_Utils_ap(ss, styles));
	});
var author$project$Internal$Styles$StyledText = F3(
	function (text, range, styles) {
		return {range: range, styles: styles, text: text};
	});
var elm$core$Basics$and = _Basics_and;
var elm$core$Basics$ge = _Utils_ge;
var elm$core$Basics$lt = _Utils_lt;
var author$project$Range$contains = F2(
	function (index, _n0) {
		var from = _n0.a;
		var to = _n0.b;
		return (_Utils_cmp(index, from) > -1) && (_Utils_cmp(index, to) < 0);
	});
...
var author$project$Internal$Styles$getStylesAt = F2(
	function (i, _n0) {
		var styles = _n0.a;
		return A3(
			elm$core$List$foldl,
			F2(
				function (_n1, acc) {
					var r = _n1.a;
					var st = _n1.b;
					return A2(author$project$Range$contains, i, r) ? A2(elm$core$List$cons, st, acc) : acc;
				}),
			_List_Nil,
			styles);
	});
var author$project$Range$Range = F2(
	function (a, b) {
		return {$: 'Range', a: a, b: b};
	});
var author$project$Range$range = F2(
	function (from, to) {
		return (_Utils_cmp(from, to) < 0) ? A2(author$project$Range$Range, from, to) : A2(author$project$Range$Range, to, from);
	});
...
var author$project$Internal$Styles$applyToText = F3(
	function (s, offset, styles) {
		var handleChar = F6(
			function (str, buf, index, startIndex, curStyles, res) {
				handleChar:
				while (true) {
					var newStyles = A2(author$project$Internal$Styles$getStylesAt, index, styles);
					var mkRange = A2(
						author$project$Range$range,
						startIndex,
						startIndex + elm$core$String$length(buf));
					var _n0 = elm$core$String$uncons(str);
					if (_n0.$ === 'Just') {
						var _n1 = _n0.a;
						var c = _n1.a;
						var rest = _n1.b;
						if (_Utils_eq(curStyles, newStyles)) {
							var $temp$str = rest,
								$temp$buf = _Utils_ap(
								buf,
								...
								$temp$curStyles = curStyles,
								$temp$res = res;
							str = $temp$str;
							buf = $temp$buf;
							index = $temp$index;
							startIndex = $temp$startIndex;
							curStyles = $temp$curStyles;
							res = $temp$res;
							continue handleChar;
						} else {
							var $temp$str = rest,
								$temp$buf = elm$core$String$fromChar(c),
								$temp$index = index + 1,
								$temp$startIndex = index,
								$temp$curStyles = newStyles,
								$temp$res = _Utils_ap(
								res,
								_List_fromArray(
									[
										A3(author$project$Internal$Styles$StyledText, buf, mkRange, curStyles)
									]));
							str = $temp$str;
							buf = $temp$buf;
							index = $temp$index;
		...
		return A6(handleChar, s, '', offset, offset, _List_Nil, _List_Nil);
	});
...
var author$project$Textarea$computeStyledTexts = function (_n0) {
	var d = _n0.a;
					...
					F2(
						function (line, _n1) {
							...
							return _Utils_Tuple2(
								offset + elm$core$String$length(lineWithLf),
								_Utils_ap(
									res,
									_List_fromArray(
										[
											A3(author$project$Internal$Styles$applyToText, lineWithLf, offset, d.styles)
										])));
						}),
...
var author$project$Textarea$applyStyles = F3(
	function (highlightId, styles, _n0) {
		var model = _n0.a;
		return _Utils_eq(model.highlightId, highlightId) ? author$project$Textarea$computeStyledTexts(
			author$project$Internal$Textarea$Model(
				_Utils_update(
					model,
					{
						styles: A2(author$project$Internal$Styles$addStyles, styles, author$project$Internal$Styles$empty)
					}))) : author$project$Internal$Textarea$Model(model);
	});
var author$project$Internal$Textarea$GetViewportPos = function (a) {
	return {$: 'GetViewportPos', a: a};
};
var author$project$Textarea$viewportId = function (d) {
	return d.idPrefix + '-viewport';
};
...
var author$project$Textarea$getViewportPos = function (_n0) {
	var d = _n0.a.a;
	var c = _n0.b;
	return _Utils_Tuple2(
		...
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					author$project$Internal$Textarea$GetViewportPos,
					elm$browser$Browser$Dom$getElement(
						author$project$Textarea$viewportId(d)))
				])));
};
var author$project$Internal$Textarea$TriggerHighlight = {$: 'TriggerHighlight'};
var author$project$Textarea$triggerHighlightNow = A2(
	elm$core$Task$perform,
	function (_n0) {
		return author$project$Internal$Textarea$TriggerHighlight;
	},
...
var author$project$Textarea$init = function (initData) {
	var initialModelData = {
		...
		styles: author$project$Internal$Styles$empty,
		text: initData.initialText,
		viewportBox: {h: 0, scrollLeft: 0, scrollTop: 0, w: 0, x: 0, y: 0}
	};
	return author$project$Textarea$getViewportPos(
		_Utils_Tuple2(
...
var author$project$Textarea2$LiftMsg = function (a) {
	return {$: 'LiftMsg', a: a};
};
...
var author$project$Textarea2$init = A2(
	elm$core$Basics$composeR,
	author$project$Textarea$init,
	elm$core$Tuple$mapSecond(
		elm$core$Platform$Cmd$map(author$project$Textarea2$LiftMsg)));
var author$project$WithElmParser2$TextareaMsg = function (a) {
	return {$: 'TextareaMsg', a: a};
};
var author$project$WithElmParser2$init = function (idPrefix) {
	var _n0 = author$project$Textarea2$init(
		A2(author$project$Textarea2$defaultInitData, idPrefix, 'let\n  foo = 1\nin\n  foo + bar'));
	var m = _n0.a;
	var c = _n0.b;
	return _Utils_Tuple2(
		{textareaModel: m},
		A2(elm$core$Platform$Cmd$map, author$project$WithElmParser2$TextareaMsg, c));
};
var author$project$WithPorts$TextareaMsg = function (a) {
	return {$: 'TextareaMsg', a: a};
};
...
var author$project$Main2$init = function () {
	var _n0 = author$project$WithElmParser2$init('ta-pure');
	var pureModel = _n0.a;
	var pureCmd = _n0.b;
	var _n1 = author$project$WithPorts$init('ta-ports');
	var portsModel = _n1.a;
	var portsCmd = _n1.b;
	return _Utils_Tuple2(
		{portsModel: portsModel, pureModel: pureModel},
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(elm$core$Platform$Cmd$map, author$project$Main2$PureMsg, pureCmd),
					A2(elm$core$Platform$Cmd$map, author$project$Main2$PortsMsg, portsCmd)
				])));
}();
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$WithElmParser2$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[elm$core$Platform$Sub$none]));
};
var author$project$Textarea$subscriptions = function (_n0) {
	var model = _n0.a;
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(
				elm$core$Platform$Sub$map,
				author$project$Main2$PureMsg,
				author$project$WithElmParser2$subscriptions(model.pureModel)),
				A2(
				elm$core$Platform$Sub$map,
				author$project$Main2$PortsMsg,
...
var author$project$Range$insertAt = F3(
	function (pos, count, _n0) {
		var from = _n0.a;
		var to = _n0.b;
		return (_Utils_cmp(pos, from) < 0) ? A2(author$project$Range$range, from + count, to + count) : (((count > 0) && (_Utils_cmp(pos, to + 1) < 1)) ? A2(author$project$Range$range, from, to + count) : (((count < 0) && (_Utils_cmp(pos, to - 1) < 1)) ? A2(author$project$Range$range, from, to + count) : A2(author$project$Range$range, from, to)));
	});
...
var author$project$Internal$Styles$insertAt = F3(
	function (pos, count, _n0) {
		var styles = _n0.a;
		return author$project$Internal$Styles$Styles(
			A2(
				...
				A2(
					elm$core$Basics$composeL,
					A2(elm$core$Basics$composeL, elm$core$Basics$not, author$project$Range$empty),
					elm$core$Tuple$first),
				A2(
					elm$core$List$map,
					elm$core$Tuple$mapFirst(
						A2(author$project$Range$insertAt, pos, count)),
					styles)));
	});
var author$project$Internal$Textarea$NoOp = {$: 'NoOp'};
var author$project$Internal$Textarea$lineSize = F2(
	function (n, text) {
		return A2(
			elm$core$Array$get,
			n,
...
var author$project$Textarea$debounceConfig = function (ms) {
	return {
		strategy: jinjor$elm_debounce$Debounce$later(ms),
		transform: author$project$Internal$Textarea$DebounceMsg
	};
};
var author$project$TextUtil$atLeft = F3(
	function (isDelim, pos, _n0) {
		var i = _n0.a;
		var c = _n0.b;
		return (_Utils_cmp(i, pos) < 0) && isDelim(c);
	});
var author$project$TextUtil$atRight = F3(
	function (isDelim, pos, _n0) {
		var i = _n0.a;
		var c = _n0.b;
		return (_Utils_cmp(i, pos) > -1) && isDelim(c);
	});
var author$project$TextUtil$candidatePosition = F2(
	function (pred, _n0) {
		var i = _n0.a;
		var c = _n0.b;
		return pred(
...
var author$project$TextUtil$maybeOrElse = F2(
	function (recover, maybe) {
		return A2(
			elm$core$Maybe$withDefault,
			recover,
			A2(elm$core$Maybe$map, elm$core$Maybe$Just, maybe));
	});
var elm$core$String$foldr = _String_foldr;
var elm$core$String$toList = function (string) {
	return A3(elm$core$String$foldr, elm$core$List$cons, _List_Nil, string);
};
var author$project$TextUtil$delimitedRangeAt = F3(
	function (isDelim, pos, text) {
		var indexed = A2(
		...
		var left = A2(
			...
			A3(
				...
				F2(
					function (ic, acc) {
						return A2(
							author$project$TextUtil$maybeOrElse,
							A2(
								author$project$TextUtil$candidatePosition,
								A2(author$project$TextUtil$atLeft, isDelim, pos),
								ic),
							acc);
					}),
				elm$core$Maybe$Nothing,
				...
				F2(
					function (ic, acc) {
						return A2(
							...
							A2(
								author$project$TextUtil$candidatePosition,
								A2(author$project$TextUtil$atRight, isDelim, pos),
								ic),
							acc);
					}),
				elm$core$Maybe$Nothing,
				indexed));
		return (elm$core$String$isEmpty(text) || _Utils_eq(right, pos)) ? elm$core$Maybe$Nothing : ((_Utils_cmp(left, right) < 0) ? elm$core$Maybe$Just(
			A2(author$project$Range$range, left + 1, right)) : elm$core$Maybe$Nothing);
	});
var author$project$TextUtil$isNewline = function (c) {
	return _Utils_eq(
		c,
		_Utils_chr('\n'));
};
var author$project$TextUtil$lineRangeAt = author$project$TextUtil$delimitedRangeAt(author$project$TextUtil$isNewline);
var author$project$Textarea$expanSelectionWith = F3(
	function (fun, pos, _n0) {
		var d = _n0.a;
		var selection = A2(
			elm$core$Maybe$withDefault,
			A2(author$project$Range$range, pos, pos),
			A2(fun, pos, d.text));
		return author$project$Internal$Textarea$Model(
			_Utils_update(
				d,
...
var author$project$Textarea$expandLineSelection = author$project$Textarea$expanSelectionWith(author$project$TextUtil$lineRangeAt);
var author$project$Range$expand = F2(
	function (to, at) {
		return (_Utils_cmp(to, at) < 1) ? A2(author$project$Range$Range, to, at) : A2(author$project$Range$Range, at, to);
	});
var author$project$Textarea$expandSelection = F2(
	function (to, _n0) {
		var d = _n0.a;
		return author$project$Internal$Textarea$Model(
			_Utils_update(
				d,
				{
					selection: A2(
						elm$core$Maybe$map,
						author$project$Range$expand(to),
						d.selectingAt)
				}));
	});
var author$project$TextUtil$isWhitespace = function (c) {
	return _Utils_eq(
		c,
		_Utils_chr(' ')) || (_Utils_eq(
		c,
		_Utils_chr('\t')) || author$project$TextUtil$isNewline(c));
};
var author$project$TextUtil$wordRangeAt = author$project$TextUtil$delimitedRangeAt(author$project$TextUtil$isWhitespace);
var author$project$Textarea$expandWordSelection = author$project$Textarea$expanSelectionWith(author$project$TextUtil$wordRangeAt);
var author$project$Internal$Textarea$GetViewport = function (a) {
	return {$: 'GetViewport', a: a};
};
var elm$browser$Browser$Dom$getViewportOf = _Browser_getViewportOf;
var author$project$Textarea$getViewportSize = function (_n0) {
	var d = _n0.a.a;
	var c = _n0.b;
	return _Utils_Tuple2(
		author$project$Internal$Textarea$Model(d),
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					A2(
					elm$core$Task$attempt,
					author$project$Internal$Textarea$GetViewport,
...
var author$project$Textarea$withOutMsg = F2(
	function (outMsg, _n0) {
		var model = _n0.a;
		var cmd = _n0.b;
		return _Utils_Tuple3(model, cmd, outMsg);
	});
var author$project$Textarea$noOut = author$project$Textarea$withOutMsg(elm$core$Maybe$Nothing);
var author$project$Range$getBounds = function (_n0) {
	var from = _n0.a;
	var to = _n0.b;
	return _Utils_Tuple2(from, to);
};
var author$project$Range$move = F2(
	function (i, _n0) {
		var from = _n0.a;
		var to = _n0.b;
...
var author$project$Textarea$requestHighlight = function (_n0) {
	var model = _n0.a.a;
	var cmd = _n0.b;
	var _n1 = A3(
		jinjor$elm_debounce$Debounce$push,
		author$project$Textarea$debounceConfig(model.debounceMs),
		model.highlightId,
		model.debounce);
	var debounce = _n1.a;
	var debounceCmd = _n1.b;
...
var author$project$Textarea$scrollCaretIntoView = F2(
	function (prevRange, _n0) {
		var d = _n0.a.a;
		var c = _n0.b;
		var scrollCmd = function (charIndex) {
			return A2(
				elm$core$Task$attempt,
				author$project$Internal$Textarea$GetCharViewport,
				elm$browser$Browser$Dom$getElement(
					A2(author$project$Textarea$charId, d, charIndex)));
		};
		var cmd = A2(
			elm$core$Maybe$withDefault,
			elm$core$Platform$Cmd$none,
			A2(
				elm$core$Maybe$map,
				function (r) {
					var _n1 = author$project$Range$getBounds(r);
					var newFrom = _n1.a;
					var newTo = _n1.b;
					if (_Utils_eq(newFrom, newTo)) {
						return scrollCmd(
							author$project$Range$getFrom(r));
					} else {
						if (prevRange.$ === 'Just') {
							var pr = prevRange.a;
							var _n3 = author$project$Range$getBounds(pr);
							var oldFrom = _n3.a;
							var oldTo = _n3.b;
							return (_Utils_eq(oldFrom, newFrom) && (!_Utils_eq(oldTo, newTo))) ? scrollCmd(newTo) : (((!_Utils_eq(oldFrom, newFrom)) && _Utils_eq(oldTo, newTo)) ? scrollCmd(newFrom) : elm$core$Platform$Cmd$none);
						} else {
...
var author$project$Textarea$setSelection = F2(
	function (r, _n0) {
		var d = _n0.a.a;
		var c = _n0.b;
		return A2(
			author$project$Textarea$scrollCaretIntoView,
			d.selection,
			_Utils_Tuple2(
				author$project$Internal$Textarea$Model(
					_Utils_update(
		...
		var _n0 = ((keyCode === 9) && (!isDown)) ? A2(
			...
			A2(
				...
				function (r) {
					...
					var from = _n1.a;
					var to = _n1.b;
					var left = A3(elm$core$String$slice, 0, from, d.text);
					var right = A3(
						elm$core$String$slice,
						to,
						elm$core$String$length(d.text),
					...
					return _Utils_Tuple2(
						left + ('  ' + right),
						elm$core$Maybe$Just(
							A2(author$project$Range$move, 2, r)));
				},
				d.selection)) : _Utils_Tuple2(
			d.text,
			elm$core$Maybe$Just(
				A2(author$project$Range$range, start, end)));
		var newText = _n0.a;
		var newSel = _n0.b;
...
var author$project$Textarea$textareaId = function (d) {
	return d.idPrefix + '-textarea';
};
var elm$browser$Browser$Dom$focus = _Browser_call('focus');
var author$project$Textarea$focusTextarea = function (d) {
	return A2(
		elm$core$Task$attempt,
		author$project$Internal$Textarea$Focused,
		elm$browser$Browser$Dom$focus(
			author$project$Textarea$textareaId(d)));
};
var author$project$Textarea$setSelectingAt = F2(
	function (at, _n0) {
		var d = _n0.a;
		return author$project$Internal$Textarea$Model(
			_Utils_update(
...
var author$project$Textarea$setCaretPos = F2(
	function (i, _n0) {
		var d = _n0.a;
		return _Utils_Tuple2(
			A2(
				author$project$Textarea$setSelectingAt,
				elm$core$Maybe$Just(i),
				author$project$Internal$Textarea$Model(d)),
			author$project$Textarea$focusTextarea(d));
	});
var author$project$Textarea$updateIfSelecting = F2(
	function (fun, _n0) {
		var model = _n0.a.a;
		var c = _n0.b;
		return (!_Utils_eq(model.selectingAt, elm$core$Maybe$Nothing)) ? A2(
			author$project$Textarea$scrollCaretIntoView,
			model.selection,
			A2(
				elm$core$Tuple$mapFirst,
	...
	function (config, msg, _n0) {
		...
		switch (msg.$) {
			...
			case 'MouseDown':
				...
				return author$project$Textarea$noOut(
					A2(
						author$project$Textarea$setCaretPos,
						i,
						author$project$Internal$Textarea$Model(model)));
			case 'MouseUp':
				var i = msg.a;
				return author$project$Textarea$noOut(
					A2(
						author$project$Textarea$updateIfSelecting,
						A2(
							elm$core$Basics$composeR,
							author$project$Textarea$expandSelection(i),
							author$project$Textarea$setSelectingAt(elm$core$Maybe$Nothing)),
						author$project$Textarea$noCmd(
							author$project$Internal$Textarea$Model(model))));
			case 'MouseOver':
				var i = msg.a;
			...
			case 'MouseClicks':
				var i = msg.a;
				var count = msg.b;
				return (count === 1.0) ? author$project$Textarea$noOut(
					A2(
						author$project$Textarea$updateIfSelecting,
						A2(
							elm$core$Basics$composeR,
						...
						A2(
							author$project$Textarea$setCaretPos,
							i,
							author$project$Internal$Textarea$Model(model)))) : ((count === 2.0) ? author$project$Textarea$noOut(
					author$project$Textarea$noCmd(
						A2(
							author$project$Textarea$expandWordSelection,
							i,
							author$project$Internal$Textarea$Model(model)))) : ((count === 3.0) ? author$project$Textarea$noOut(
					author$project$Textarea$noCmd(
						A2(
							author$project$Textarea$expandLineSelection,
							i,
							author$project$Internal$Textarea$Model(model)))) : author$project$Textarea$noOut(
					author$project$Textarea$noCmd(
						author$project$Internal$Textarea$Model(model)))));
			case 'MouseOverLine':
				var n = msg.a;
				return author$project$Textarea$noOut(
					A2(
						...
						function (_n2) {
							...
							return A2(
								elm$core$Maybe$withDefault,
								author$project$Internal$Textarea$Model(m),
								A2(
									elm$core$Maybe$map,
									function (s) {
										return A2(
											author$project$Textarea$expandSelection,
											s - 1,
											author$project$Internal$Textarea$Model(m));
									},
									A2(author$project$Internal$Textarea$lineSize, n, m.text)));
						},
						author$project$Textarea$noCmd(
							author$project$Internal$Textarea$Model(model))));
			case 'MouseUpLine':
				...
				return author$project$Textarea$noOut(
					A2(
						...
						A2(
							...
							A2(author$project$Internal$Textarea$lineSize, lineIndex, model.text))));
			case 'BackgroundMouseDown':
				return author$project$Textarea$noOut(
					A2(
						author$project$Textarea$setCaretPos,
						elm$core$String$length(model.text),
						author$project$Internal$Textarea$Model(model)));
			case 'BackgroundMouseOver':
				return author$project$Textarea$noOut(
					A2(
						author$project$Textarea$updateIfSelecting,
						author$project$Textarea$expandSelection(
				...
				return author$project$Textarea$noOut(
					author$project$Textarea$noCmd(
						A2(
							...
							elm$core$Maybe$Nothing,
							author$project$Internal$Textarea$Model(model))));
			case 'BackgroundMouseEnter':
				var buttons = msg.a;
				return (1 === buttons) ? author$project$Textarea$noOut(
					author$project$Textarea$noCmd(
						A2(
							author$project$Textarea$setSelectingAt,
			...
			case 'GetViewportPos':
				...
				if (element.$ === 'Ok') {
					var e = element.a;
					var box = model.viewportBox;
					return author$project$Textarea$noOut(
						author$project$Textarea$getViewportSize(
							author$project$Textarea$noCmd(
								author$project$Internal$Textarea$Model(
									_Utils_update(
										model,
										{
											viewportBox: _Utils_update(
												box,
												{x: e.element.x, y: e.element.y})
										})))));
				} else {
					return author$project$Textarea$noOut(
						author$project$Textarea$noCmd(
								...
								return author$project$Internal$Textarea$Model(
									_Utils_update(
										model,
										{
											viewportBox: _Utils_update(
												box,
												{h: v.viewport.height, w: v.viewport.width})
										}));
							} else {
								return author$project$Internal$Textarea$Model(model);
							}
						}()));
			case 'GetCharViewport':
				var element = msg.a;
				if (element.$ === 'Ok') {
					var e = element.a;
					var setScroll = F2(
						function (x, y) {
							return A2(
								elm$core$Task$attempt,
								function (_n7) {
									return author$project$Internal$Textarea$NoOp;
								},
								A3(
									elm$browser$Browser$Dom$setViewportOf,
									author$project$Textarea$viewportId(model),
									x,
									y));
						});
					var scrollTop = model.viewportBox.scrollTop;
					var scrollLeft = model.viewportBox.scrollLeft;
					var lead = e.element.height;
					var viewportLeft = model.viewportBox.x + lead;
					var viewportRight = (viewportLeft + model.viewportBox.w) - (2 * lead);
					var viewportTop = model.viewportBox.y + lead;
					var viewportBottom = (viewportTop + model.viewportBox.h) - (2 * lead);
					var charTop = e.element.y;
					var topDelta = viewportTop - charTop;
					var charLeft = e.element.x;
					var charRight = charLeft + e.element.width;
					var rightDelta = charRight - viewportRight;
					var leftDelta = viewportLeft - charLeft;
					var newScrollLeft = (rightDelta > 0) ? (scrollLeft + rightDelta) : ((leftDelta > 0) ? (scrollLeft - leftDelta) : scrollLeft);
					var charBottom = charTop + e.element.height;
					var bottomDelta = charBottom - viewportBottom;
					var newScrollTop = (bottomDelta > 0) ? (scrollTop + bottomDelta) : ((topDelta > 0) ? (scrollTop - topDelta) : scrollTop);
					return author$project$Textarea$noOut(
						_Utils_Tuple2(
							author$project$Internal$Textarea$Model(model),
							A2(setScroll, newScrollLeft, newScrollTop)));
				} else {
					return author$project$Textarea$noOut(
						_Utils_Tuple2(
							author$project$Internal$Textarea$Model(model),
			...
			case 'DebounceMsg':
				...
				var _n8 = A4(
					...
					jinjor$elm_debounce$Debounce$takeLast(
						function (_n9) {
							return author$project$Textarea$triggerHighlightNow;
						}),
					m,
					model.debounce);
				var debounce = _n8.a;
			...
			case 'TriggerHighlight':
				return A2(
					...
					elm$core$Maybe$Just(
						author$project$Textarea$RequestHighlight(
...
var author$project$Textarea2$ApplyStyles = F2(
	function (a, b) {
		return {$: 'ApplyStyles', a: a, b: b};
	});
var author$project$Textarea2$update = F3(
	function (config, msg, model) {
		var config_ = {
			highlighter: elm$core$Basics$always(_List_Nil),
			lift: A2(elm$core$Basics$composeL, config.lift, author$project$Textarea2$LiftMsg),
			predictionConfig: config.predictionConfig
		};
		if (msg.$ === 'LiftMsg') {
			var sub = msg.a;
			var _n1 = A3(author$project$Textarea$update, config_, sub, model);
			var tm = _n1.a;
			var c = _n1.b;
			var o = _n1.c;
			var cmd = function () {
				if ((o.$ === 'Just') && (o.a.$ === 'RequestHighlight')) {
					...
					var applyStyles = A2(
						elm$core$Basics$composeL,
						config.lift,
						author$project$Textarea2$ApplyStyles(hr.id));
					var requestHighlight = config.requestHighlight(applyStyles);
					return A2(
						elm$core$Task$perform,
						requestHighlight,
						elm$core$Task$succeed(hr.text));
				} else {
					return elm$core$Platform$Cmd$none;
				}
			}();
				...
				elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							...
							A2(elm$core$Basics$composeL, config.lift, author$project$Textarea2$LiftMsg),
							c),
							cmd
						])));
		} else {
			var id = msg.a;
			var styles = msg.b;
			var model1 = A3(author$project$Textarea$applyStyles, id, styles, model);
			return _Utils_Tuple2(model1, elm$core$Platform$Cmd$none);
		}
	});
var author$project$WithElmParser2$Identifier = {$: 'Identifier'};
var author$project$WithElmParser2$Keyword = {$: 'Keyword'};
var author$project$WithElmParser2$highlight = function (text) {
	var stylify = F2(
		function (style, word) {
			return A2(
				elm$core$List$map,
				function (i) {
					return _Utils_Tuple2(
						A2(
							author$project$Range$range,
							i,
							i + elm$core$String$length(word)),
						style);
				},
				A2(elm$core$String$indexes, word, text));
		});
	var stylifyMany = F2(
		function (style, words) {
			return elm$core$List$concat(
				A2(
					elm$core$List$map,
					stylify(style),
	...
	var keywords = A2(
		stylifyMany,
		author$project$WithElmParser2$Keyword,
		_List_fromArray(
			['if', 'then', 'else', 'let', 'in', 'module']));
	var identifiers = A2(
		stylifyMany,
		author$project$WithElmParser2$Identifier,
		_List_fromArray(
			['foo', 'bar']));
	return _Utils_ap(keywords, identifiers);
};
var author$project$WithElmParser2$TextClicked = {$: 'TextClicked'};
var author$project$WithElmParser2$renderer = function (myStyles) {
	return A3(
		elm$core$List$foldl,
		F2(
					...
					return _Utils_ap(
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onClick(author$project$WithElmParser2$TextClicked)
							]));
				} else {
					return _Utils_ap(
						attrs,
...
var author$project$WithElmParser2$updateConfig = {
	highlighter: author$project$WithElmParser2$renderer,
	lift: author$project$WithElmParser2$TextareaMsg,
	predictionConfig: elm$core$Maybe$Nothing,
	requestHighlight: F2(
		function (applyStyles, text) {
			return applyStyles(
				author$project$WithElmParser2$highlight(text));
		})
};
var author$project$WithElmParser2$update = F2(
	function (msg, model) {
		if (msg.$ === 'TextareaMsg') {
			var sub = msg.a;
			var _n1 = A3(author$project$Textarea2$update, author$project$WithElmParser2$updateConfig, sub, model.textareaModel);
			var tm = _n1.a;
			var c = _n1.b;
			return _Utils_Tuple2(
				_Utils_update(
...
var author$project$Textarea$encodeHighlightRequest = function (r) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var author$project$Textarea$rangeDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Range$range,
	A2(elm$json$Json$Decode$field, 'from', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'to', elm$json$Json$Decode$int));
var author$project$Textarea$highlightResponseDecoder = function (styleDecoder) {
	var rangeAndStyleDecoder = A3(
		elm$json$Json$Decode$map2,
		F2(
			function (range, styleValue) {
				return _Utils_Tuple2(range, styleValue);
			}),
		A2(elm$json$Json$Decode$field, 'range', author$project$Textarea$rangeDecoder),
		A2(elm$json$Json$Decode$field, 'style', styleDecoder));
	return A3(
		elm$json$Json$Decode$map2,
...
var author$project$WithPorts$Keyword = {$: 'Keyword'};
var elm$json$Json$Decode$andThen = _Json_andThen;
var elm$json$Json$Decode$fail = _Json_fail;
var author$project$WithPorts$myStyleDecoder = A2(
	elm$json$Json$Decode$andThen,
	function (s) {
		switch (s) {
			case 'keyword':
				return elm$json$Json$Decode$succeed(author$project$WithPorts$Keyword);
			case 'identifier':
				return elm$json$Json$Decode$succeed(author$project$WithPorts$Identifier);
			default:
				var unknownStyle = s;
				return elm$json$Json$Decode$fail('Unknown style ' + unknownStyle);
		}
	},
		...
		switch (msg.$) {
			...
			case 'OnParseResult':
				...
				var hlr = A2(
					...
					author$project$Textarea$highlightResponseDecoder(author$project$WithPorts$myStyleDecoder),
					v);
				if (hlr.$ === 'Ok') {
					var highlightResponse = hlr.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								textareaModel: A3(author$project$Textarea$applyStyles, highlightResponse.id, highlightResponse.styles, model.textareaModel)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var e = hlr.a;
...
var author$project$Main2$update = F2(
	function (msg, model) {
		if (msg.$ === 'PureMsg') {
			var sub = msg.a;
			var _n1 = A2(author$project$WithElmParser2$update, sub, model.pureModel);
			var m = _n1.a;
			var c = _n1.b;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{pureModel: m}),
				A2(elm$core$Platform$Cmd$map, author$project$Main2$PureMsg, c));
		} else {
			var sub = msg.a;
			var _n2 = A2(author$project$WithPorts$update, sub, model.portsModel);
			var m = _n2.a;
			var c = _n2.b;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{portsModel: m}),
				A2(elm$core$Platform$Cmd$map, author$project$Main2$PortsMsg, c));
		}
	});
var author$project$Internal$Textarea$BackgroundMouseDown = {$: 'BackgroundMouseDown'};
var author$project$Internal$Textarea$BackgroundMouseEnter = function (a) {
	return {$: 'BackgroundMouseEnter', a: a};
};
var author$project$Internal$Textarea$BackgroundMouseLeft = {$: 'BackgroundMouseLeft'};
var author$project$Internal$Textarea$BackgroundMouseOver = {$: 'BackgroundMouseOver'};
var author$project$Internal$Textarea$BackgroundMouseUp = {$: 'BackgroundMouseUp'};
var author$project$Internal$Textarea$Blurred = {$: 'Blurred'};
var author$project$Internal$Textarea$MouseDownLine = function (a) {
	return {$: 'MouseDownLine', a: a};
};
var author$project$Internal$Textarea$MouseOverLine = function (a) {
	return {$: 'MouseOverLine', a: a};
};
var author$project$Internal$Textarea$MouseUpLine = function (a) {
	return {$: 'MouseUpLine', a: a};
};
var author$project$Internal$Textarea$OnInput = F3(
	function (a, b, c) {
...
var author$project$Textarea$mouseEnterEvent = function (createMsg) {
	return A2(
...
var author$project$Textarea$adjustIndex = F2(
	function (offsetX, clientWidth) {
		return (_Utils_cmp(offsetX, clientWidth * 0.5) > -1) ? 1 : 0;
	});
var elm$json$Json$Decode$float = _Json_decodeFloat;
var author$project$Textarea$mouseEvent = F2(
	function (name, createMsg) {
		return A2(
			elm$html$Html$Events$custom,
			name,
			A3(
				...
				F2(
					function (offsetX, w) {
						return {
							message: createMsg(
								A2(author$project$Textarea$adjustIndex, offsetX, w)),
							preventDefault: true,
							stopPropagation: true
						};
					}),
...
var author$project$Internal$Textarea$MouseClicks = F2(
	function (a, b) {
		return {$: 'MouseClicks', a: a, b: b};
	});
var author$project$Internal$Textarea$MouseDown = function (a) {
	return {$: 'MouseDown', a: a};
};
var author$project$Internal$Textarea$MouseOver = function (a) {
	return {$: 'MouseOver', a: a};
};
var author$project$Internal$Textarea$MouseUp = function (a) {
	return {$: 'MouseUp', a: a};
};
var author$project$Range$isCaret = F2(
	function (i, _n0) {
		var from = _n0.a;
		var to = _n0.b;
		return _Utils_eq(from, to) && _Utils_eq(from, i);
	});
var author$project$Textarea$mouseClickEvent = function (createMsg) {
	return A2(
		elm$html$Html$Events$custom,
		'click',
		A4(
...
var author$project$Textarea$renderStyledText = F4(
	function (m, lift, highlighter, st) {
		var selRange = m.selection;
		var from = author$project$Range$getFrom(st.range);
		var dataFrom = function (f) {
			return A2(
		...
		var charAttrs = function (i) {
			var _n2 = A2(
				...
				A2(
					...
					function (r) {
						return _Utils_Tuple2(
							A2(author$project$Range$contains, from + i, r),
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							A2(author$project$Textarea$charId, m, from + i)),
							A2(
							author$project$Textarea$mouseEvent,
							'mousedown',
							function (adjust) {
								return lift(
									author$project$Internal$Textarea$MouseDown((from + i) + adjust));
							}),
							A2(
							author$project$Textarea$mouseEvent,
							'mouseover',
							function (adjust) {
								return lift(
									author$project$Internal$Textarea$MouseOver((from + i) + adjust));
							}),
							A2(
							author$project$Textarea$mouseEvent,
							'mouseup',
							function (adjust) {
								return lift(
									author$project$Internal$Textarea$MouseUp((from + i) + adjust));
							}),
							author$project$Textarea$mouseClickEvent(
							F2(
								function (adjust, count) {
									return lift(
										A2(author$project$Internal$Textarea$MouseClicks, (from + i) + adjust, count));
								}))
						]),
		...
		var attrs = highlighter(st.styles);
		return A2(
			elm$html$Html$span,
			attrs,
			A2(
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A2(elm$html$Html$Attributes$style, 'border-left', '1px solid black'),
											A2(elm$html$Html$Attributes$style, 'position', 'absolute'),
											A2(elm$html$Html$Attributes$style, 'top', '0'),
											A2(elm$html$Html$Attributes$style, 'left', '0'),
											A2(elm$html$Html$Attributes$style, 'bottom', '0'),
											...
											elm$html$Html$Attributes$class('blinking-cursor')
										]),
...
var author$project$Textarea$view = F2(
	function (config, _n0) {
		...
		var _n1 = A2(
			elm$core$Maybe$withDefault,
			_Utils_Tuple2(0, 0),
			A2(elm$core$Maybe$map, author$project$Range$getBounds, d.selection));
		var ss = _n1.a;
		var se = _n1.b;
		return A2(
			elm$html$Html$div,
				...
				[
					...
					_List_fromArray(
						[
							...
							'mousedown',
							function (_n2) {
								return lift(author$project$Internal$Textarea$BackgroundMouseDown);
							}),
							A2(
							author$project$Textarea$mouseEvent,
							'mouseover',
							function (_n3) {
								return lift(author$project$Internal$Textarea$BackgroundMouseOver);
							}),
							A2(
							author$project$Textarea$mouseEvent,
							'mouseup',
							function (_n4) {
								return lift(author$project$Internal$Textarea$BackgroundMouseUp);
							}),
							A2(
							author$project$Textarea$mouseEvent,
							'mouseleave',
							function (_n5) {
								return lift(author$project$Internal$Textarea$BackgroundMouseLeft);
							}),
							author$project$Textarea$mouseEnterEvent(
							function (buttons) {
								return lift(
									author$project$Internal$Textarea$BackgroundMouseEnter(buttons));
							}),
							A2(
							elm$html$Html$Events$on,
							'scroll',
							A3(
								...
								F2(
									function (left, top) {
										return lift(
											A2(author$project$Internal$Textarea$Scrolled, left, top));
									}),
								A2(
									elm$json$Json$Decode$at,
									_List_fromArray(
					...
					_List_fromArray(
						[
							A2(elm$html$Html$Attributes$attribute, 'scoped', '')
						]),
					_List_fromArray(
						[
					...
					A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$value(d.text),
								elm$html$Html$Attributes$id(
								author$project$Textarea$textareaId(d)),
								A2(elm$html$Html$Attributes$style, 'position', 'fixed'),
								A2(elm$html$Html$Attributes$style, 'padding', '0'),
								...
								'selectionStart',
								elm$json$Json$Encode$int(ss)),
								A2(
								elm$html$Html$Attributes$property,
								'selectionEnd',
								elm$json$Json$Encode$int(se)),
								...
								A4(
									elm$json$Json$Decode$map3,
									author$project$Internal$Textarea$OnInput,
									A2(
										elm$json$Json$Decode$at,
										_List_fromArray(
											['target', 'value']),
								...
								elm$html$Html$Events$on,
								'blur',
								elm$json$Json$Decode$succeed(author$project$Internal$Textarea$Blurred))
							]),
						_List_Nil))
				]));
	});
var author$project$Textarea2$view = F2(
	function (config, model) {
		...
		return A2(author$project$Textarea$view, config_, model);
	});
var author$project$WithElmParser2$config = {highlighter: author$project$WithElmParser2$renderer, lift: author$project$WithElmParser2$TextareaMsg, predictionConfig: elm$core$Maybe$Nothing};
var elm$html$Html$h2 = _VirtualDom_node('h2');
var author$project$WithElmParser2$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(author$project$Textarea2$view, author$project$WithElmParser2$config, model.textareaModel)
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Textarea... with style !')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Examples app for the '),
						A2(
						elm$html$Html$a,
						_List_fromArray(
							[
								elm$html$Html$Attributes$href('https://github.com/vankeisb/elm-rich-textarea')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('elm-rich-textarea')
							])),
				...
				_List_fromArray(
					[
						...
						elm$html$Html$map,
						author$project$Main2$PureMsg,
						author$project$WithElmParser2$view(model.pureModel)),
						A2(
						elm$html$Html$div,
						_List_fromArray(
							[
...
var author$project$Main2$main = elm$browser$Browser$element(
	{
		init: function (_n0) {
			return author$project$Main2$init;
		},
		subscriptions: author$project$Main2$subscriptions,
		update: author$project$Main2$update,
		view: author$project$Main2$view
	});
_Platform_export({'Main2':{'init':author$project$Main2$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main2.Msg","aliases":{"Textarea.Msg":{"args":[],"type":"Internal.Textarea.Msg"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"},"Textarea.HighlightId":{"args":[],"type":"Internal.Textarea.Uuid"},"Browser.Dom.Element":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float }, element : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"},"Browser.Dom.Viewport":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"}},"unions":{"Main2.Msg":{"args":[],"tags":{"PureMsg":["WithElmParser2.Msg"],"PortsMsg":["WithPorts.Msg"]}},"WithElmParser2.Msg":{"args":[],"tags":{"TextareaMsg":["Textarea2.Msg WithElmParser2.MyStyle WithElmParser2.Msg"],"TextClicked":[]}},"WithPorts.Msg":{"args":[],"tags":{"TextareaMsg":["Textarea.Msg"],"TextClicked":[],"OnParseResult":["Json.Decode.Value"],"OnPredictResult":["Json.Decode.Value"]}},"Internal.Textarea.Msg":{"args":[],"tags":{"OnInput":["String.String","Basics.Int","Basics.Int"],"OnKeyDown":["Basics.Int","Basics.Bool","Basics.Int","Basics.Int"],"OnKeyUp":["Basics.Int","Basics.Bool","Basics.Int","Basics.Int"],"MouseDown":["Basics.Int"],"MouseUp":["Basics.Int"],"MouseOver":["Basics.Int"],"MouseDownLine":["Basics.Int"],"MouseOverLine":["Basics.Int"],"MouseUpLine":["Basics.Int"],"MouseClicks":["Basics.Int","Basics.Float"],"BackgroundMouseDown":[],"BackgroundMouseOver":[],"BackgroundMouseUp":[],"BackgroundMouseLeft":[],"BackgroundMouseEnter":["Basics.Int"],"Focused":["Result.Result Browser.Dom.Error ()"],"Blurred":[],"GetViewportPos":["Result.Result Browser.Dom.Error Browser.Dom.Element"],"GetViewport":["Result.Result Browser.Dom.Error Browser.Dom.Viewport"],"GetCharViewport":["Result.Result Browser.Dom.Error Browser.Dom.Element"],"Scrolled":["Basics.Float","Basics.Float"],"DebounceMsg":["Debounce.Msg"],"TriggerHighlight":[],"GetPredictionCharViewport":["Result.Result Browser.Dom.Error Browser.Dom.Element"],"PredictionClicked":["Basics.Int"],"NoOp":[]}},"Textarea2.Msg":{"args":["s","m"],"tags":{"LiftMsg":["Textarea.Msg"],"ApplyStyles":["Textarea.HighlightId","List.List ( Range.Range, s )"]}},"WithElmParser2.MyStyle":{"args":[],"tags":{"Keyword":[],"Identifier":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Internal.Textarea.Uuid":{"args":[],"tags":{"Uuid":["Basics.Int"]}},"Range.Range":{"args":[],"tags":{"Range":["Basics.Int","Basics.Int"]}},"Browser.Dom.Error":{"args":[],"tags":{"NotFound":["String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Debounce.Msg":{"args":[],"tags":{"NoOp":[],"Flush":["Maybe.Maybe Basics.Float"],"SendIfLengthNotChangedFrom":["Basics.Int"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}}}}})}});}(this));